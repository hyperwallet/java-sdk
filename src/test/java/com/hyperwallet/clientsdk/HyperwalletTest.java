...
public class HyperwalletTest {
    ...
    public void testListUserStatusTransitions_withParameters_noUserToken() throws Exception {
        Hyperwallet client = new Hyperwallet("test-username", "test-password");
        try {
            client.listUserStatusTransitions(null, new HyperwalletUsersListPaginationOptions());
            fail("Expect HyperwalletException");
        } catch (HyperwalletException e) {
            assertThat(e.getErrorCode(), is(nullValue()));
            assertThat(e.getResponse(), is(nullValue()));
    ...
    public void testListUserStatisTransitions_withParameters() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/status-transitions?createdAfter=2016-06-29T17:58:26Z&createdBefore=2016-06-29T17:58:26Z&sortBy=test-sort-by&offset=5&limit=10&transition=ACTIVATED"), Mockito.any(TypeReference.class));
    }
    ...
    public void testCreateUserStatusTransition_successful() throws Exception {
        ...
        Mockito.verify(mockApiClient).post(Mockito
                        .eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/status-transitions"),
    ...
    public void testListPrepaidCards_withParameters() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/prepaid-cards?createdAfter=2016-06-29T17:58:26Z&createdBefore=2016-06-29T17:58:26Z&sortBy=test-sort-by&offset=5&limit=10&status=ACTIVATED"), Mockito.any(TypeReference.class));
    }
    ...
    public void testListPaperChecks_withParameters() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/paper-checks?createdAfter=2016-06-29T17:58:26Z&createdBefore=2016-06-29T17:58:26Z&sortBy=test-sort-by&offset=5&limit=10&status=ACTIVATED"), Mockito.any(TypeReference.class));
    }
    ...
    public void testCreateTransferStatusTransition_successful() throws Exception {
        ...
        ArgumentCaptor<HyperwalletStatusTransition> argument = ArgumentCaptor.forClass(HyperwalletStatusTransition.class);
        Mockito.verify(mockApiClient)
                .post(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/transfers/test-transfer-token/status-transitions"), argument.capture(),
    ...
    public void testGetTransferStatusTransition_successful() throws Exception {
        ...
        Mockito.verify(mockApiClient)
                .get("https://api.sandbox.hyperwallet.com/rest/v3/transfers/transfer-Token/status-transitions/status-TransitionToken",
    ...
    public void testlistTransferStatusTransition() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito
                        .eq("https://api.sandbox.hyperwallet.com/rest/v3/transfers/test-user-token/status-transitions?createdAfter=2016-06-29T17:58"
                                + ":26Z&createdBefore=2016-06-29T17:58:26Z&sortBy=test-sort-by&limit=10"),
                Mockito.any(TypeReference.class));
    }
    ...
    public void testDeactivatePayPalAccountStatusTransition_successful() throws Exception {
        ...
        ArgumentCaptor<HyperwalletStatusTransition> argument = ArgumentCaptor.forClass(HyperwalletStatusTransition.class);
        Mockito.verify(mockApiClient).post(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/paypal-accounts/test-paypal-account-token/status-transitions"), argument.capture(), Mockito.eq(statusTransitionResponse.getClass()));
    ...
    public void testCreatePayPalAccountStatusTransition_successful() throws Exception {
        ...
        ArgumentCaptor<HyperwalletStatusTransition> argument = ArgumentCaptor.forClass(HyperwalletStatusTransition.class);
        Mockito.verify(mockApiClient).post(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/paypal-accounts/test-paypal-account-token/status-transitions"), argument.capture(), Mockito.eq(transition.getClass()));
    ...
    public void testUpdatePayPalAccount_successful() throws Exception {
        ...
        ArgumentCaptor<HyperwalletPayPalAccount> argument = ArgumentCaptor.forClass(HyperwalletPayPalAccount.class);
        Mockito.verify(mockApiClient)
                .put(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/paypal-accounts/test-paypal-account-token"),
    ...
    public void testCreateVenmoAccount_noType() throws Exception {
        ...
        Mockito.verify(mockApiClient)
                .post(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/venmo-accounts"), argument.capture(),
    ...
    @Test
    public void testGetVenmoAccount_noPayPalAccountToken() {
        Hyperwallet client = new Hyperwallet("test-username", "test-password");
        try {
    ...
    public void testGetVenmoAccount_successful() throws Exception {
        ...
        Mockito.verify(mockApiClient).get("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/venmo-accounts/test-venmo-account-token",
    ...
    public void testListVenmoAccount_noListOptions() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/venmo-accounts"),
                Mockito.any(TypeReference.class));
    }

    @Test
    public void testListVenmoAccount_withParameters() throws Exception {
        HyperwalletList<HyperwalletVenmoAccount> response = new HyperwalletList<HyperwalletVenmoAccount>();
        ...
        Mockito.verify(mockApiClient).get(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/venmo-accounts?createdAfter=2016-06-29T17:58:26Z&createdBefore=2016-06-29T17:58:26Z&sortBy=test-sort-by&offset=5&limit=10&type=VENMO_ACCOUNT&status=ACTIVATED"), Mockito.any(TypeReference.class));
    }

    @Test
    public void testListVenmoAccount_withSomeParameters() throws Exception {
        HyperwalletList<HyperwalletVenmoAccount> response = new HyperwalletList<HyperwalletVenmoAccount>();
        ...
        Mockito.verify(mockApiClient).get(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/venmo-accounts?createdBefore=2016-06-29T17:58:26Z&sortBy=test-sort-by&offset=5"), Mockito.any(TypeReference.class));
    }
    ...
    public void testVenmoAccountListTransfer_withListOptions() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito
                        .eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/venmo-accounts?createdAfter=2020-08-20T21:58:26Z"
    ...
    @Test
    public void testDeactivateVenmoAccountStatusTransition_noPayPalAccountToken() throws Exception {
        Hyperwallet client = new Hyperwallet("test-username", "test-password");
        try {
    ...
    public void testDeactivateVenmoAccountStatusTransition_successful() throws Exception {
        ...
        ArgumentCaptor<HyperwalletStatusTransition> argument = ArgumentCaptor.forClass(HyperwalletStatusTransition.class);
        Mockito.verify(mockApiClient).post(Mockito
                        .eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/venmo-accounts/test-venmo-account-token/status"
                                + "-transitions"),
                argument.capture(), Mockito.eq(statusTransitionResponse.getClass()));
    ...
    @Test
    public void testCreateVenmoAccountStatusTransition_noPayPalAccountToken() {
        Hyperwallet client = new Hyperwallet("test-username", "test-password");
        try {
    ...
    @Test
    public void testGetVenmoAccountStatusTransition_noPayPalAccountToken() {
        Hyperwallet client = new Hyperwallet("test-username", "test-password");
        try {
    ...
    public void testGetVenmoAccountStatusTransition_successful() throws Exception {
        ...
        Mockito.verify(mockApiClient)
                .get("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/venmo-accounts/test-venmo-account-token/status-transitions"
    ...
    @Test
    public void testListVenmoAccountStatusTransitions_noParameters_noPayPalAccountToken() throws Exception {
        Hyperwallet client = new Hyperwallet("test-username", "test-password");
        try {
    ...
    @Test
    public void testListVenmoAccountStatusTransitions_withParameters_noPayPalAccountToken() throws Exception {
        Hyperwallet client = new Hyperwallet("test-username", "test-password");
        try {
    ...
    public void testListVenmoAccountStatusTransitions_withParameters() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito
                        .eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/venmo-accounts/test-venmo-account-token/status"
                        + "-transitions?createdAfter=2020-08-20T23:14:26Z&createdBefore=2020-08-20T23:14:26Z&sortBy=test-sort-by&offset=5&limit=10"),
                Mockito.any(TypeReference.class));
    }
    ...
    public void testUpdateVenmoAccount_successful() throws Exception {
        ...
        ArgumentCaptor<HyperwalletVenmoAccount> argument = ArgumentCaptor.forClass(HyperwalletVenmoAccount.class);
        Mockito.verify(mockApiClient)
                .put(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/venmo-accounts/test-venmo-account-token"),
    ...
    public void testListBankAccountStatusTransitions_withParameters_noUserToken() throws Exception {
        Hyperwallet client = new Hyperwallet("test-username", "test-password");
        try {
            client.listBankAccountStatusTransitions(null, null, new HyperwalletBankAccountListPaginationOptions());
            fail("Expect HyperwalletException");
        } catch (HyperwalletException e) {
            assertThat(e.getErrorCode(), is(nullValue()));
            assertThat(e.getResponse(), is(nullValue()));
    ...
    public void testListBankAccountStatusTransitions_withParameters_noBankAccountToken() throws Exception {
        Hyperwallet client = new Hyperwallet("test-username", "test-password");
        try {
            client.listBankAccountStatusTransitions("test-user-token", null, new HyperwalletBankAccountListPaginationOptions());
            fail("Expect HyperwalletException");
        } catch (HyperwalletException e) {
            assertThat(e.getErrorCode(), is(nullValue()));
            assertThat(e.getResponse(), is(nullValue()));
    ...
    public void testListBankAccountStatisTransitions_withParameters() throws Exception {
        ...
        HyperwalletBankAccountListPaginationOptions options = new HyperwalletBankAccountListPaginationOptions();
        options.transition(HyperwalletBankAccount.Status.ACTIVATED)
                .status(HyperwalletBankAccount.Status.ACTIVATED)
                .sortBy("test-sort-by")
                .offset(5)
                .limit(10)
    ...
    public void testListReceiptsForUser_withParameters() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/users/test-user-token/receipts?createdAfter=2016-06-29T17:58:26Z&createdBefore=2016-06-29T17:58:26Z&sortBy=test-sort-by&offset=5&limit=10&type=ANNUAL_FEE&currency=USD"), Mockito.any(TypeReference.class));
    }
    ...
    public void testListWebhookEvents_withParameters() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/webhook-notifications?createdAfter=2016-08-24T13:56:26Z&createdBefore=2016-08-24T13:56:26Z&sortBy=test-sort-by&offset=5&limit=10&type=USERS.PREPAID_CARDS.CREATED&programToken=test-program-token"), Mockito.any(TypeReference.class));
    }

    @DataProvider(name = "webhook")
    public static Object[][] streamData() {
        return new Object[][]{{"USERS.CREATED", HyperwalletWebhookNotification.Type.USER_CREATED},
                {"USERS.UPDATED", HyperwalletWebhookNotification.Type.USER_UPDATED},
                {"USERS.UPDATED.STATUS.ACTIVATED", HyperwalletWebhookNotification.Type.USER_UPDATED_STATUS_ACTIVATED},
                {"USERS.UPDATED.STATUS.LOCKED", HyperwalletWebhookNotification.Type.USER_UPDATED_STATUS_LOCKED},
                {"USERS.UPDATED.STATUS.FROZEN", HyperwalletWebhookNotification.Type.USER_UPDATED_STATUS_FROZEN},
                {"USERS.UPDATED.STATUS.DE_ACTIVATED", HyperwalletWebhookNotification.Type.USER_UPDATED_STATUS_DE_ACTIVATED},
                {"USERS.BANK_ACCOUNTS.CREATED", HyperwalletWebhookNotification.Type.BANK_ACCOUNT_CREATED},
                {"USERS.BANK_ACCOUNTS.UPDATED", HyperwalletWebhookNotification.Type.BANK_ACCOUNT_UPDATED},
                {"USERS.PREPAID_CARDS.CREATED", HyperwalletWebhookNotification.Type.PREPAID_CARD_CREATED},
                {"USERS.PAPER_CHECKS.CREATED", HyperwalletWebhookNotification.Type.PAPER_CHECK_CREATED},
                {"USERS.PAYPAL_ACCOUNTS.CREATED", HyperwalletWebhookNotification.Type.PAYPAL_ACCOUNT_CREATED},
                {"USERS.VENMO_ACCOUNTS.CREATED", HyperwalletWebhookNotification.Type.VENMO_ACCOUNT_CREATED},
                {"USERS.BUSINESS_STAKEHOLDERS.UPDATED.VERIFICATION_STATUS.REQUIRED",
                        HyperwalletWebhookNotification.Type.USER_BUSINESS_STAKEHOLDER_UPDATED_VERIFICATION_STATUS_REQUIRED},
                {"USERS.BANK_CARDS.CREATED", HyperwalletWebhookNotification.Type.BANK_CARD_CREATED},
                {"USERS.BANK_ACCOUNTS.DIRECT_DEBIT_AUTHORIZATIONS.CREATED", HyperwalletWebhookNotification.Type.BANK_ACCOUNT_DDA_CREATED},
                {"PAYMENTS.CREATED", HyperwalletWebhookNotification.Type.PAYMENTS_CREATED},
                {"TRANSFERS.UPDATED.STATUS.SCHEDULED", HyperwalletWebhookNotification.Type.TRANSFERS_UPDATED_STATUS_SCHEDULED},
                {"TRANSFERS.REFUND.CREATED", HyperwalletWebhookNotification.Type.TRANSFERS_REFUND_CREATED},
                {"PAYMENT_ROUTING_ACCOUNTS.CREATED", HyperwalletWebhookNotification.Type.PAYMENT_ROUTING_ACCOUNTS_CREATED}};
    }
    ...
    public void testCreateTransferRefund_successful() throws Exception {
        ...
        Mockito.verify(mockApiClient).post(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/transfers/" + transferToken + "/refunds"), argument.capture(), Mockito.eq(transferRefund.getClass()));
    ...
    public void testGetTransferRefund_successful() throws Exception {
        ...
        Mockito.verify(mockApiClient).get("https://api.sandbox.hyperwallet.com/rest/v3/transfers/transferToken/refunds/transferRefundToken", transferRefund.getClass());
    }
    ...
    public void testListTransferRefunds_noParameters() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/transfers/" + transferToken + "/refunds"), Mockito.any(TypeReference.class));
    }
    ...
    public void testListTransferRefunds_withSomeParameters() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito.eq("https://api.sandbox.hyperwallet.com/rest/v3/transfers/" + transferToken + "/refunds" + "?createdBefore=2016-06-29T17:58:26Z&sortBy=test-sort-by&sourceToken=test-source-token"), Mockito.any(TypeReference.class));
    }
    ...
    public void testListTransferRefunds_noTransferToken() {
        Hyperwallet client = new Hyperwallet("test-username", "test-password");
        try {
            client.listTransferRefunds(null, new HyperwalletTransferListOptions());
            fail("Expect HyperwalletException");
        } catch (HyperwalletException e) {
            HyperwalletException expectedException = new HyperwalletException("Transfer token is required");
            checkHyperwalletException(e, expectedException);
