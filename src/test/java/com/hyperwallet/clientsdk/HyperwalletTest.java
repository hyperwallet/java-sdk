...
public class HyperwalletTest {
    ...
    public void testListUsers_withParameters() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito
                        .eq("https://api.sandbox.hyperwallet.com/rest/v4/users?createdAfter=2016-06-29T17:58:26Z&createdBefore=2016-06-29T17:58:26Z&sortBy=test-sort-by&offset=5&limit=10"),
    ...
    public void testListUserStatisTransitions_withParameters() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito
                        .eq("https://api.sandbox.hyperwallet.com/rest/v4/users/test-user-token/status-transitions?createdAfter=2016-06-29T17:58:26Z&createdBefore=2016-06-29T17:58:26Z&sortBy=test-sort-by&offset=5&limit=10"),
                Mockito.any(TypeReference.class));
    }
    ...
    public void testListPrepaidCards_withParameters() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito
                        .eq("https://api.sandbox.hyperwallet.com/rest/v4/users/test-user-token/prepaid-cards?createdAfter=2016-06-29T17:58:26Z&createdBefore=2016-06-29T17:58:26Z&sortBy=test-sort-by&offset=5&limit=10"),
                Mockito.any(TypeReference.class));
    }
    ...
    public void testListPayPalAccountStatusTransitions_withParameters() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito
                        ...
                        + "-transitions?createdAfter=2016-06-29T17:58:26Z&createdBefore=2016-06-29T17:58:26Z&sortBy=test-sort-by&offset=5&limit=10"),
                Mockito.any(TypeReference.class));
    }
    ...
    public void testListBankAccounts_withSomeParameters() throws Exception {
        ...
        Mockito.verify(mockApiClient).get(Mockito
                        .eq("https://api.sandbox.hyperwallet.com/rest/v4/users/test-user-token/bank-accounts?createdBefore=2016-06-29T17:58:26Z&sortBy=test-sort-by&offset=5"),
                Mockito.any(TypeReference.class));
    }
